const content = {
  ...
  fa: {
    ...
    questions: [
      // Set I
      "اگه می‌تونستی هر کسی رو توی دنیا انتخاب کنی، دوست داشتی مهمون شامت کی باشه؟",
      "دوست داری معروف بشی؟ اگه آره، به چه شکلی؟",
      "قبل از تماس تلفنی، شده توی ذهنت تمرین کنی چی بگی؟ چرا؟",
      "به نظر تو یه روز «بی‌نقص» چه شکلیه؟",
      "آخرین بار کی برای خودت آهنگ خوندی؟ برای یه نفر دیگه چی؟",
      "اگه بتونی تا ۹۰ سالگی زندگی کنی و توی ۶۰ سال آخر یا ذهن ۳۰ سالگی رو داشته باشی یا بدن ۳۰ سالگی رو، کدوم رو انتخاب می‌کنی؟",
      "ته دلت یه حدس مخفی درباره نحوه مرگت داری؟",
      "سه تا چیزی که فکر می‌کنی با پارتنرت مشترک دارین رو بگو.",
      "برای چی توی زندگیت بیشتر از همه حس قدردانی داری؟",
      "اگه می‌تونستی یه چیزی رو توی نحوه بزرگ شدنت تغییر بدی، چی رو عوض می‌کردی؟",
      "چهار دقیقه وقت بذار و داستان زندگیت رو تا جایی که می‌تونی با جزئیات تعریف کن.",
      "اگه فردا صبح بیدار بشی و یه ویژگی یا توانایی جدید داشته باشی، دوست داری اون چی باشه؟",
      // Set II
      "اگه یه گوی جادویی می‌تونست حقیقت رو درباره خودت، زندگیت، آینده یا هر چیز دیگه‌ای بهت بگه، دوست داشتی چی رو بدونی؟",
      "یه کاری هست که مدت‌هاست دلت می‌خواد انجامش بدی؟ چرا هنوز انجامش ندادی؟",
      "بزرگ‌ترین موفقیت زندگیت چی بوده؟",
      "توی دوستی، چی برات از همه مهم‌تره؟",
      "قشنگ‌ترین خاطره‌ای که داری چیه؟",
      "سخت‌ترین یا بدترین خاطره‌ای که داری چیه؟",
      "اگه بدونی یه سال دیگه ناگهانی می‌میری، چیزی رو توی سبک زندگیت عوض می‌کنی؟ چرا؟",
      "دوستی برای تو چه معنی‌ای داره؟",
      "عشق و محبت توی زندگیت چه نقشی دارن؟",
      "نوبتی یه ویژگی مثبت از پارتنرت بگو. جمعا پنج تا مورد بگین.",
      "فضای خانواده‌تون چقدر صمیمی و گرمه؟ حس می‌کنی بچگیت نسبت به بیشتر آدما شادتر بوده؟",
      "در مورد رابطه‌ات با مادرت چه حسی داری؟",
      // Set III
      "هر کدومتون سه تا جمله واقعی با «ما» بسازین. مثلا: «ما الان توی این اتاقیم و ... حس می‌کنیم.»",
      "این جمله رو کامل کن: «کاش یه نفر بود که می‌تونستم ... رو باهاش شریک بشم.»",
      "اگه قرار باشه با پارتنرت خیلی صمیمی بشی، چه چیزی مهمه که درباره‌ات بدونه؟",
      "به پارتنرت بگو چی توی اون دوست داری؛ این بار خیلی صادقانه و حتی چیزهایی که شاید به یه آشنای جدید نگی.",
      "یه لحظه خجالت‌آور از زندگیت رو تعریف کن.",
      "آخرین بار کی جلوی یه نفر گریه کردی؟ وقتی تنها بودی چی؟",
      "یه چیزی که همین الان توی پارتنرت دوست داری بهش بگو.",
      "به نظرت چه چیزی اون‌قدر جدیه که جای شوخی نداره؟",
      "اگه امشب بدون اینکه فرصت حرف زدن با کسی داشته باشی بمیری، بیشتر از نگفتن چه چیزی پشیمون می‌شی؟ چرا هنوز نگفتیش؟",
      "فرض کن خونه‌ات با همه وسایلت آتیش گرفته. بعد از نجات عزیزات و حیوان خونگی، فقط وقت داری یه چیز دیگه برداری. چی رو برمی‌داری؟ چرا؟",
      "بین آدم‌های خانواده‌ات، از دست دادنِ چه کسی بیشتر از همه ناراحتت می‌کنه؟ چرا؟",
      "یه مشکل شخصی رو مطرح کن و از پارتنرت بخواه بگه اگه جای تو بود چطور باهاش روبه‌رو می‌شد. بعد ازش بخواه برداشتش از احساس تو نسبت به این مشکل رو هم بگه.",
    ],
  },
};
